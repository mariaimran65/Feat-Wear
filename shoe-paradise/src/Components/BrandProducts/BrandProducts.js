...
const navigation = [
  { name: "Adidas", href: "#", icon: HomeIcon, current: true },
  { name: "Nike", href: "#", icon: UsersIcon, current: false },
  { name: "Service", href: "#", icon: FolderIcon, current: false },
  { name: "Bata", href: "#", icon: CalendarIcon, current: false },
